...
\begin{frame}{Instalando o Node.js (via NVM -- recomendado)}
...
\begin{lstlisting}[language=bash]
# Criar pasta e inicializar projeto
mkdir meu-backend && cd meu-backend
npm init -y          # gera package.json com defaults
...
\begin{frame}{Entregável da Aula 1}
...
\begin{itemize}
  ...
  \item \textbf{Tarefa}: publicar o reposit\'orio com o entregável descrito acima.
\end{itemize}
\end{frame}
